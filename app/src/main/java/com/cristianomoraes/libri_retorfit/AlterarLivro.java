...
public class AlterarLivro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int cod_livro = getIntent()
                        .getExtras()
                        .getInt("cod_livro");

        routerInterface = APIUtil.getUsuarioInterface();
        Call<List<Livro>> callGetLivroId =
                routerInterface.getLivroId(cod_livro);
            ...
            public void onResponse(Call<List<Livro>> call, Response<List<Livro>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    btnEditar.setOnClickListener(view -> {
                        ...
                        Call<Livro> callUpdateLivro =
                                            routerInterface.updateLivro(livro);
                        ...
                        callUpdateLivro.enqueue(new Callback<Livro>() {
                            ...
                            public void onResponse(Call<Livro> call, Response<Livro> response) {
                                ...
                                startActivity(new Intent(AlterarLivro.this,
                                                         FeedLivro.class));
